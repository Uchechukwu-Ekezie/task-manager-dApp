...
export default function TaskDApp() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-green-500 via-teal-500 to-orange-500 flex items-center justify-center">
      <div className="max-w-lg w-full p-8 bg-white rounded-lg shadow-lg">
        <h1 className="text-3xl font-bold text-center mb-6 text-gray-900">TASK M-DAPP</h1>
